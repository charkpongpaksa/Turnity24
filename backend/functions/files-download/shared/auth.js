...
const tokenLifetimeSeconds = Number(process.env.AUTH_TOKEN_TTL_SECONDS || 28800); // 8 hours
const refreshLifetimeSeconds = Number(process.env.REFRESH_TOKEN_TTL_SECONDS || 2592000); // 30 days
...
export function parseToken(token, expectedType = "access") {
